...
def readImg2array(file,size, threshold= 30):
...
#Update
def update(w,y_vec,theta=0.5,time=10000):
    for s in range(time):
        m = len(y_vec)
...
#Initial setting
def hopfield(train_files, test_files,theta=0.5, time=10000, size=(100,100),threshold=200, current_path=None):
...
hopfield(train_files=train_paths, test_files=test_paths, theta=0.5,time=10000,size=(100,100),threshold=50, current_path = current_path)